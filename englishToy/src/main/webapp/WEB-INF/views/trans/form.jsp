...
<script>
	...
	function trans() {
		...
		// json으로 처리할때는 post방식을 사용한다 
		var httpMethod = "GET"; //방식
		var httpParam = "source=" + source + "&target=" + target + "&text="+ encodeURIComponent(textarea.value); // 파라미터 한글이면 깨지지 않게 인코딩해줌
	...
	function translate() {
		if(httpRequest.readyState == 4 && httpRequest.status == 200){
			...
			let changeText = result.transText.replaceAll(/(\n|\r\n)/g, "&#10");
		...
		<div class="trans-row">
			<div class="col-6 col-md-auto" ><!-- section -->
				...
				<div class="trans-card ">
					...
					<div class="trans-card-footer">
						<button type="button" class="trans-btn btn1"  onclick="trans(this)">번역하기</button>
					</div>
			...
			<div class="col-6 col-md-auto" ><!-- section -->
				<div class="trans-card ">
					...
					<form action="${cpath}/word/insert" method="post" id="form">
						<div class="trans-card-body" style ="white-space: pre-wrap">
